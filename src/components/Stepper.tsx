...
import React, { useState, Children, useRef, useLayoutEffect, useEffect, type ReactNode } from 'react';
...
export interface StepperProps {
  ...
  beforeStepChange?: (from: number, to: number, isDirectClick?: boolean) => boolean;
...
export default function Stepper({
  ...
  const updateStep = (newStep: number, isDirectClick = false) => {
    // Run validation hook if provided
    if (beforeStepChange && !beforeStepChange(currentStep, newStep, isDirectClick)) {
      return;
    }
